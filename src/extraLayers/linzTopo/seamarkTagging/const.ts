...
const MAP = <const>{
  ...
  CATBRG: {
    ...
    2: ['opening', 'opening bridge'],
    3: ['swing', 'swing bridge'],
    4: ['lifting', 'lifting bridge'],
    5: ['bascule', 'bascule bridge'],
    6: ['pontoon', 'pontoon bridge'],
    7: ['drawbridge', 'draw bridge'],
    8: ['transporter', 'transporter bridge'],
    9: ['footbridge', 'footbridge'],
    10: ['viaduct', '	viaduct'],
    11: ['aqueduct', 'aqueduct'],
    12: ['suspension', 'suspension bridge'],
  },
  CATDPG: {
